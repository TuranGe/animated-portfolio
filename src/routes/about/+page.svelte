<script>
  ...
  const timeline = [
    {
      year: "2024",
      title: "Senior Creative Dev",
      place: "Freelance & Studio Work",
    },
    {
      year: "2022",
      title: "Lead Frontend Developer",
      place: "Digital Agency XYZ",
    },
  ...
  async function goBack() {
    ...
    try {
      ...
      sessionStorage.setItem("returnSection", from !== null ? from : "2");
    } catch (e) {}
    goto("/");
  }
...
<!-- Ambient glows -->
<div
  style="position:fixed;width:550px;height:550px;border-radius:50%;top:-120px;right:-80px;background:radial-gradient(circle,var(--accent) 0%,transparent 65%);filter:blur(90px);opacity:.08;pointer-events:none;z-index:99;"
></div>
<div
  style="position:fixed;width:400px;height:400px;border-radius:50%;bottom:-100px;left:-60px;background:radial-gradient(circle,var(--accent) 0%,transparent 65%);filter:blur(80px);opacity:.07;pointer-events:none;z-index:99;"
></div>
...
>
  <div style="padding:0 clamp(24px,6vw,96px);max-width:1100px;margin:0 auto;">
    ...
    <div class="ab-hero" style="margin-bottom:clamp(48px,8vw,96px);">
      ...
      <h1
        style="font-family:'Playfair Display',serif;font-size:clamp(3.5rem,10vw,9rem);
                 font-weight:600;line-height:1;color:var(--fg);margin-bottom:28px;opacity:0;"
      >
        Hello,<br /><em style="color:var(--accent);">World.</em>
      </h1>
      <p
        style="font-family:'Playfair Display',serif;font-size:clamp(1.2rem,2.5vw,1.8rem);
                color:var(--fg);font-weight:300;line-height:1.6;max-width:680px;opacity:0;"
      >
        I'm a creative developer who thrives at the intersection of design and
        technology.
      </p>
    </div>
    ...
    <!-- Portrait + bio -->
    <div
      class="ab-section ab-portrait-bio"
      style="display:grid;grid-template-columns:1fr 1fr;gap:clamp(40px,6vw,80px);
                                    margin-bottom:clamp(48px,8vw,96px);align-items:center;"
    >
      <div
        style="position:relative;aspect-ratio:3/4;overflow:hidden;border-radius:2px;"
      >
        <div
          style="width:100%;height:100%;background:linear-gradient(160deg,var(--bg2),var(--bg));"
        >
          <div
            style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;opacity:.2;"
          >
        ...
        <div
          style="position:absolute;bottom:0;left:0;width:2px;height:100%;background:var(--accent);"
        ></div>
      </div>

      <div style="display:flex;flex-direction:column;gap:18px;">
        <p style="color:var(--fg2);line-height:1.85;">
          With over 5 years of experience in both design and development, I
          bring a unique perspective to every project. I started as a designer,
          learned to code out of necessity — and fell in love with the craft.
        </p>
        <p style="color:var(--fg2);line-height:1.85;">
          I believe the best digital experiences are those that feel inevitable
          — where every interaction, every transition, every typographic choice
          feels exactly right.
        </p>
        <p style="color:var(--fg2);line-height:1.85;">
          When I'm not in front of a screen, you'll find me exploring film
          photography, reading about architecture, or hunting for the perfect
          espresso.
        </p>
      ...
      <div class="skills-grid">
        {#each skills as g, i}
          <div class="skill-card">
            <p
              style="font-family:'Playfair Display',serif;font-size:1.2rem;font-weight:600;
            ...
            >
              {#each g.items as item}
                <li
                  style="display:flex;align-items:center;gap:10px;color:var(--fg2);font-size:.9rem;"
                >
                  <span
                    style="width:4px;height:4px;border-radius:50%;background:var(--accent);opacity:.5;flex-shrink:0;"
                  ></span>
                  {item}
                </li>
              {/each}
    ...
    <div class="ab-section" style="margin-bottom:clamp(48px,8vw,96px);">
      ...
      {#each timeline as t}
        <div
          style="display:grid;grid-template-columns:100px 1fr 1fr;gap:16px;
                    padding:24px 0;border-top:1px solid var(--border);"
        >
          <span class="label" style="color:var(--accent);">{t.year}</span>
          <p
            style="font-family:'Playfair Display',serif;font-size:1.15rem;
                    font-weight:600;color:var(--fg);"
          >
            {t.title}
          </p>
          <p style="color:var(--fg2);font-size:.9rem;align-self:center;">
            {t.place}
          </p>
        </div>
      {/each}
    ...
    <div class="ab-section" style="text-align:center;padding-bottom:2rem;">
      <button
        on:click={() => {
          try {
            sessionStorage.setItem("fromSection", "2");
          } catch (e) {}
          goto("/contact");
        }}
        class="label"
