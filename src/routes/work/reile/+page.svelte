...
>
  ...
  >
    ...
    >
      <div style="display:flex;align-items:center;gap:var(--work-row-gap);">
        <span
          class="label"
          style="width:32px;flex-shrink:0;color:rgba(255,255,255,.45);"
          >{project.num}</span
        >
    ...
    <div
      ...
      style="position:absolute;width:700px;height:700px;border-radius:50%;top:-200px;right:-60px;background:radial-gradient(circle,#f97316 0%,transparent 65%);filter:blur(90px);opacity:0;pointer-events:none;transition:opacity 2.0s ease;"
    ></div>
    <div
      class="hero-glow hero-glow-2"
      style="position:absolute;width:500px;height:500px;border-radius:50%;bottom:-100px;left:-80px;background:radial-gradient(circle,#f97316 0%,transparent 65%);filter:blur(80px);opacity:0;pointer-events:none;transition:opacity 2.4s ease 0.5s;"
    ></div>
    <div
      class="hero-glow hero-glow-3"
      style="position:absolute;width:300px;height:300px;border-radius:50%;top:35%;right:28%;background:radial-gradient(circle,#f97316 0%,transparent 65%);filter:blur(65px);opacity:0;pointer-events:none;transition:opacity 2.2s ease 1.0s;"
    ></div>
  ...
  >
    <div class="reveal" style="margin-bottom:48px;">
      <p class="label" style="margin-bottom:14px;color:{ACCENT_CLR};">
      ...
      <div
        style="display:flex;flex-wrap:wrap;gap:clamp(24px,4vw,64px);
    ...
    <div
      class="reveal"
      style="display:grid;grid-template-columns:1fr 2.5fr;gap:48px;margin-bottom:80px;align-items:start;"
    >
      <div>
      ...
      <p
        style="font-family:'Playfair Display',serif;font-size:clamp(1.2rem,2vw,1.6rem);
                line-height:1.65;font-weight:300;color:var(--fg);"
      >
        {project.overview}
      </p>
    </div>
    ...
    <div
      class="reveal"
      style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:80px;"
    >
      {#each project.tags as tag}
        <span
          class="label"
          style="border:1px solid var(--border);padding:8px 16px;color:{ACCENT_CLR};"
          >{tag}</span
        >
      {/each}
    </div>
    ...
    >
      {#each Array(6) as _, i}
        <div
          style="aspect-ratio:4/3;border-radius:6px;overflow:hidden;border:1px solid var(--border);
                    background:linear-gradient(135deg,var(--bg2),var(--bg));"
        >
          <div
            style="width:100%;height:100%;display:flex;align-items:flex-end;padding:16px;"
          >
            <div style="width:100%;">
              <div
                style="height:7px;border-radius:2px;width:60%;margin-bottom:6px;background:{ACCENT_CLR}33;"
              ></div>
              <div
                style="height:5px;border-radius:2px;width:40%;background:rgba(255,255,255,.06);"
              ></div>
            </div>
          </div>
        </div>
