...
>
  ...
  >
    ...
    <div
      ...
      style="position:absolute;width:700px;height:700px;border-radius:50%;top:-200px;right:-60px;background:radial-gradient(circle,#c084fc 0%,transparent 65%);filter:blur(90px);opacity:0;pointer-events:none;transition:opacity 2.0s ease;"
    ></div>
    <div
      class="hero-glow hero-glow-2"
      style="position:absolute;width:500px;height:500px;border-radius:50%;bottom:-100px;left:-80px;background:radial-gradient(circle,#c084fc 0%,transparent 65%);filter:blur(80px);opacity:0;pointer-events:none;transition:opacity 2.4s ease 0.5s;"
    ></div>
    <div
      class="hero-glow hero-glow-3"
      style="position:absolute;width:300px;height:300px;border-radius:50%;top:35%;right:28%;background:radial-gradient(circle,#c084fc 0%,transparent 65%);filter:blur(65px);opacity:0;pointer-events:none;transition:opacity 2.2s ease 1.0s;"
    ></div>
  ...
  >
    <div class="reveal" style="margin-bottom:48px;">
      <p class="label" style="margin-bottom:14px;color:#c084fc;">
      ...
      {#each Array(6) as _, i}
        ...
        >
          ...
          >
            <div>
              <div
                style="height:6px;width:55%;border-radius:2px;margin-bottom:5px;background:#c084fc;opacity:.3;"
              ></div>
              <div
